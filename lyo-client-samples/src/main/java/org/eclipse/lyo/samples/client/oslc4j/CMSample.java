...
public class CMSample {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        // for jazz.net apps, this is the baseUri for the server, e.g.,
        // https://ce4iot.rtp.raleigh.ibm.com:9443/ccm
    ...
    private static boolean validateOptions(CommandLine cmd) {
        ...
        if (!(cmd.hasOption("catalogURL") && (cmd.hasOption("providerTitle")))) {
