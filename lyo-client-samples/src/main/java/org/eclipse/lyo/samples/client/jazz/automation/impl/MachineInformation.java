...
public class MachineInformation {
        ...
        try {
            ...
            if (!InetAddress.getLocalHost().isLoopbackAddress()) {
                ...
                if (getInterfaceIpAddrs(null)) {
                    ...
                    if (!addrsIPv4.isEmpty()) addrMap = addrsIPv4;
                    else addrMap = addrsIPv6;
                    ...
                    // If we didn't find any routable IP addresses, we'll just have to use the
    ...
    private boolean getInterfaceIpAddrs(String name) throws SocketException {
        ...
        if (addrsIPv4 == null) addrsIPv4 = new HashMap<InetAddress, NetworkInterface>();
        else addrsIPv4.clear();
        if (addrsIPv6 == null) addrsIPv6 = new HashMap<InetAddress, NetworkInterface>();
        else addrsIPv6.clear();
