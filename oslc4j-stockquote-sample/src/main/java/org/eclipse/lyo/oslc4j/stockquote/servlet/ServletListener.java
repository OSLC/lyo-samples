	   ...
	   implements ServletContextListener
{
	...
	public void contextInitialized(final ServletContextEvent servletContextEvent)
	{
		...
		copyContextToSystemIfEmpty("org.eclipse.lyo.oslc4j.client.registryuri", context);
		copyContextToSystemIfEmpty("org.eclipse.lyo.oslc4j.client.uiuri", context);
	...
	private void copyContextToSystemIfEmpty(final String key, final ServletContext context) {
		if (System.getProperty(key) == null) {
			logger.info("Setting system property " + key);
			final String initParameter = context.getInitParameter(key);
			if (initParameter != null) {
				System.setProperty(key, initParameter);
				logger.info("System property " + key + "=" + System.getProperty(key));
			}
		}
	}
